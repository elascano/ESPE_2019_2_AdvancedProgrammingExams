 ...
 * @author nycha
 */
public class tGuiaDetalle1 extends javax.swing.JFrame {

    /**
     * Creates new form crearG
     */
    public tGuiaDetalle1() {
        initComponents();
        bloquear();
   ...
   //     mostrar();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        consultaTransportista g=new consultaTransportista();
        g.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tGuiaDetalle1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new tGuiaDetalle1().setVisible(true);
            }
        });
    }
