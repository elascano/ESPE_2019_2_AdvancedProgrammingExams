 ...
 * @author nycha
 */
public class clienteGuiaDetalle extends javax.swing.JFrame {

    /**
     * Creates new form crearG
     */
    public clienteGuiaDetalle() {
        initComponents();
        bloquear();
   ...
   //     mostrar();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        consultaCliente g=new consultaCliente();
        g.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(clienteGuiaDetalle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new clienteGuiaDetalle().setVisible(true);
            }
        });
    }
