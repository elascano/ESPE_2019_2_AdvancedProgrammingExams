 ...
 * @author nycha
 */
public class guiaDetalleCons extends javax.swing.JFrame {

    /**
     * Creates new form crearG
     */
    public guiaDetalleCons() {
        initComponents();
        bloquear();
   ...
   //     mostrar();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(guiaDetalleCons.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new guiaDetalleCons().setVisible(true);
            }
        });
    }
