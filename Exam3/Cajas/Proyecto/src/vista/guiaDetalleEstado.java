 ...
 * @author nycha
 */
public class guiaDetalleEstado extends javax.swing.JFrame {

    /**
     * Creates new form crearG
     */
    public guiaDetalleEstado() {
        initComponents();
        bloquear();
   ...
   //     mostrar();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        consultaEstado g=new consultaEstado();
        g.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(guiaDetalleEstado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new guiaDetalleEstado().setVisible(true);
            }
        });
    }
