 ...
 * @author nycha
 */
public class consultaTransportista extends javax.swing.JFrame {

    /**
     * Creates new form leergu
     */
    public consultaTransportista() {
        initComponents();
        tabla();
       // tabla1();
        val();
    ...
    //    t.
    transportistaDAO transportista=new transportistaDAO();;
    transportista.mostrarClienteComno(jComboBox1);
          // tabla();

    }
    
        public void tabla(){
            transportistaDAO tr=new transportistaDAO();
            tr.mostrarTransportistaCd(jComboBox1.getSelectedItem().toString());
          ArrayList <transportistaVO> listaC = new ArrayList <transportistaVO>();
          listaC=tr.mostrarTransportistaNmbre(jComboBox1.getSelectedItem().toString());
        ...
        guiaDAO guiaDAO=new guiaDAO();
          ArrayList <guiaVO> lista = new ArrayList <guiaVO>();
           lista=guiaDAO.mostrarGuiaT(ced1);
...
//               columna[4]=lista.get(i).getCorreo();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/contransportista.png"))); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        tGuiaDetalle1 l1= new tGuiaDetalle1();
...
//               columna[4]=lista.get(i).getCorreo();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(consultaTransportista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new consultaTransportista().setVisible(true);
            }
        });
    }
