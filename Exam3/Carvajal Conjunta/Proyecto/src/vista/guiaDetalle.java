 ...
 * @author nycha
 */
public class guiaDetalle extends javax.swing.JFrame {
   ...
   //     mostrar();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(guiaDetalle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new guiaDetalle().setVisible(true);
            }
        });
    }
