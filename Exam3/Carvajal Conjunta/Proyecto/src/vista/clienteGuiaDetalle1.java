 ...
 * @author nycha
 */
public class clienteGuiaDetalle1 extends javax.swing.JFrame {

    /**
     * Creates new form crearG
     */
    public clienteGuiaDetalle1() {
        initComponents();
        bloquear();
   ...
   //     mostrar();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        consultafecha g=new consultafecha();
        g.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(clienteGuiaDetalle1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new clienteGuiaDetalle1().setVisible(true);
            }
        });
    }
